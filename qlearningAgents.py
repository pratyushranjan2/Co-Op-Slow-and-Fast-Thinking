...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state, pacmanInfo=None):
        """
        ...
        """
        "*** YOUR CODE HERE ***"
        actions = self.getLegalActions(state, pacmanInfo)
        if len(actions) == 0:
            return None
        maxValue = float("-inf")
        stateAction = ""
    ...
    def getAction(self, state, pacmanInfo=None):
        """
        ...
        """
        # Pick Action
        legalActions = self.getLegalActions(state, pacmanInfo)
        action = None
        "*** YOUR CODE HERE ***"
        ...
        if util.flipCoin(self.epsilon):
            ...
            action = self.computeActionFromQValues(state, pacmanInfo)
...
class PacmanQAgent(QLearningAgent):
    ...
    def getAction(self, state, pacmanInfo=None):
        ...
        method.
        """
        action = QLearningAgent.getAction(self,state,pacmanInfo)
